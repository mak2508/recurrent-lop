import math  # For mathematical operations like sqrt, etc.
import torch  # For PyTorch tensor operations
from torch.optim.optimizer import Optimizer  # Base class for optimizers in PyTorch

class AdamGnT(Optimizer):
    """Implements Adam algorithm for generate-and-test.
